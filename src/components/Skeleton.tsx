...
export function HeroSkeleton() {
  return (
    <section className="relative h-[70vh] min-h-120 w-full overflow-hidden bg-linear-to-r from-white/[0.04] to-black">
      <div className="absolute inset-0 animate-pulse bg-linear-to-r from-black via-white/[0.02] to-transparent" />
